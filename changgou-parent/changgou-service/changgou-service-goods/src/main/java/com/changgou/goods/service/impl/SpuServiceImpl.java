...
public class SpuServiceImpl implements SpuService {
    ...
    public void restore(Long id) {
        ...
        if (!spu.getIsDelete().equals("1")){
            throw new RuntimeException("无法还原未删除的商品");
        }
    ...
    /**
     * update tb_spu set isMarketable = '1' where id in (...) and isMarketable = '0' and status = '1' and isDelete = '0';
     * @param ids
     * @return
     */
    @Override
    ...
    public void put(Long spuId) {
        ...
        if (spu.getIsDelete().equals("1")){
            throw new RuntimeException("已被删除的商品无法上架");
        }
        if (!spu.getStatus().equals("1")){
            throw new RuntimeException("未经审核的商品无法上架");
        }
        //商品上架
        spu.setIsMarketable("1");
        spuMapper.updateByPrimaryKeySelective(spu);
    ...
    public void delete(String id){
        Spu spu = spuMapper.selectByPrimaryKey(id);
        if (!spu.getIsDelete().equals("1")){
            throw new RuntimeException("此商品未经逻辑删除");
        }
